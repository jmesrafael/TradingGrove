...
// Deliberately NOT cached: the unread badge must reflect reality and
// realtime inserts would fight a sessionStorage copy.
...
function subscribeNotifications(userId, onInsert) {
  return db
