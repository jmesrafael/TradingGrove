...
function applyLogoTheme(themeId){const logo=document.getElementById('headerLogo');if(!logo)return;logo.src=themeId==='light'?'/src/assets/images/dark.png':'/src/assets/images/light.png';}
